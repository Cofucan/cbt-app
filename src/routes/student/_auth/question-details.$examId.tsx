...
function RouteComponent() {
        ...
        const { selectedAnswers, totalQuestions, examStartTime } = location.state || {};
                ...
                <div className="mt-10">
                    ...
                    <div className="flex justify-between items-center w-[90%] mx-auto py-5">
                        <button
                            ...
                            className="mt-6 bg-[#ffeee8] font-semibold text-[#ff6636] px-7 lg:px-14 py-3 flex items-center gap-2"
                        >
                            Go Back
                        </button>
                        <button
                            onClick={ToggleOpenModal}
                            className="mt-6 bg-[#ff6636] font-semibold text-white px-7 lg:px-14 py-3 flex items-center gap-2"
                        >
                            Submit Test
                        </button>
                    </div>
