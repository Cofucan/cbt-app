...
export const useDownloadTemplate = (): UseMutationResult<
  ...
  return useMutation({
    mutationFn: async (): Promise<DownloadTemplateResponse> => {
      const response = await fetch(
        `${baseUrl}/app_admin/exams/exam-template-download/`,
        {
          method: "GET",
          headers: {
    ...
    onSuccess: (blob: DownloadTemplateResponse) => {
      ...
      link.href = url;
      link.download = "SampleExamTemplate.xlsx"; // Adjust file name as needed
